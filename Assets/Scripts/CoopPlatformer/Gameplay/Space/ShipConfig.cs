...
namespace CoopPlatformer.Gameplay.Space
{
    ...
    {
        [Header("Movement")] [SerializeField] private float _moveSpeed = 12f;
        ...
        [Header("Combat")] [SerializeField] private int _maxHealth = 5;
        ...
        [Header("Input")] [SerializeField] private float _touchMoveDeadZone = 0.6f;
