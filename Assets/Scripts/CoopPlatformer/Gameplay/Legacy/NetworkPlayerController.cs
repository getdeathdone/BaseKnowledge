...
namespace CoopPlatformer.Gameplay.Player
{
    ...
    public class NetworkPlayerController : NetworkBehaviour
    {
        ...
        private Vector2 _lastSentMoveInput = new(float.NaN, float.NaN);
        ...
        private void Update()
        {
            ...
            var moveInput = new Vector2(Input.GetAxisRaw("Horizontal"), 0f);
        ...
        private void FixedUpdate()
        {
            ...
            if (_jumpRequested && IsGrounded()) _rb.AddForce(Vector2.up * _jumpForce, ForceMode2D.Impulse);
